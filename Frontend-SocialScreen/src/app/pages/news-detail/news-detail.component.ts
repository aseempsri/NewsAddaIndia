...
export class NewsDetailComponent implements OnInit, OnDestroy {
  ...
  private updateMetaForShare() {
    ...
    this.title.setTitle(headlineHindi + ' - Social Screen');
    ...
    this.meta.updateTag({ property: 'og:site_name', content: 'Social Screen' });
    ...
    this.meta.updateTag({ name: 'twitter:site', content: '@socialscreenin' });
  }
