      ...
      <div class="container mx-auto px-4 py-12 lg:py-16">
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div class="lg:col-span-1">
            <a [routerLink]="'/'" aria-label="Social Screen home" class="inline-block mb-6">
              <img
                [src]="logoPath"
                alt=""
                class="block h-12 sm:h-14 w-auto max-w-[min(300px,90vw)] object-contain object-left"
                loading="eager"
                height="56" />
            </a>
          ...
          <div>
            ...
            <ul class="space-y-3">
              ...
              <li class="flex items-center gap-3">
                ...
                <a
                  href="mailto:contact@socialscreen.in"
                  class="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  contact&#64;socialscreen.in
                </a>
              </li>
              <li class="flex items-center gap-3">
                <svg class="w-5 h-5 text-primary shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export class FooterComponent implements OnInit, OnDestroy {
  ...
  socialLinks: SocialLink[] = this.buildSocialLinks();

  private buildSocialLinks(): SocialLink[] {
    const s = environment.socialMedia;
    return [
      {
