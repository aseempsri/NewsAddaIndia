...
export class VideoBannerComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {
  ...
  // Social Media URLs
  instagramUrl = environment.socialMedia.instagram;
  youtubeUrl = environment.socialMedia.youtube;
  youtubeLatestVideoUrl: string | null = null;
  showYoutubeEmbed = false;
  safeYoutubeEmbedUrl: SafeResourceUrl | null = null;
  twitterUrl = environment.socialMedia.twitter;
  facebookUrl = environment.socialMedia.facebook;
