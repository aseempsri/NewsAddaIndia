          ...
          <div class="space-y-6">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
              ...
              <a
                ...
                class="glass-card p-8 rounded-xl hover:shadow-lg transition-all duration-300 cursor-pointer group">
                <div class="flex flex-col items-center text-center space-y-4">
                  <div class="w-20 h-20 bg-cyan-500/10 rounded-full flex items-center justify-center group-hover:bg-cyan-500/20 transition-colors">
                  ...
                  <p class="text-muted-foreground">Browse all images from published news in chronological order</p>
                  <div class="flex items-center text-cyan-500 group-hover:translate-x-2 transition-transform">
                    <span class="font-medium">Go to Image Gallery</span>
                    <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
                  </div>
