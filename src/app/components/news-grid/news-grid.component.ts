  ...
  newsItems: NewsItem[] = [
    {
      id: 1,
      category: 'Health',
      title: 'Winter Health Tips: How to Stay Healthy During Cold Season',
      excerpt: 'Expert advice on maintaining your health and immunity during the winter months with practical tips.',
    ...
    },
    {
      id: 2,
      category: 'Sports',
      title: 'India vs Australia: Day 2 Highlights from the Border-Gavaskar Trophy',
      excerpt: 'Thrilling cricket action as India fights back on day two of the crucial test match series.',
    ...
    },
    {
      id: 3,
      category: 'Business',
      title: 'Stock Markets Hit New Highs Amid Global Economic Optimism',
      excerpt: 'Indian stock markets surge to record levels as investors show confidence in economic growth.',
    ...
    },
    {
      ...
      title: 'Bollywood\'s Biggest Releases This Holiday Season',
      excerpt: 'A look at the most anticipated films set to release during the festive holiday period.',
    ...
    },
    {
      ...
      title: 'Global Leaders Meet for Climate Summit 2025',
      excerpt: 'World leaders gather to discuss critical climate action plans and sustainability goals.',
    ...
    },
    {
      id: 6,
      category: 'Technology',
      title: 'AI Revolution: New Developments in Artificial Intelligence',
      excerpt: 'The latest breakthroughs in AI technology that are reshaping industries worldwide.',
