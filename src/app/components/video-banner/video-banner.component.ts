      ...
      <div 
        ...
        <div class="absolute bottom-4 left-4 z-10 flex items-center gap-3" [class.opacity-0]="isLoading">
          <a [href]="instagramUrl" target="_blank" rel="noopener noreferrer" 
             ...
             class="w-[38px] h-[38px] rounded-full bg-background/80 backdrop-blur-sm border border-border/50 flex items-center justify-center text-foreground hover:bg-background hover:border-primary transition-all duration-300 shadow-[0_0_15px_rgba(225,48,108,0.5)] hover:shadow-[0_0_20px_rgba(225,48,108,0.7)] group"
             title="Instagram">
          ...
          <a [href]="youtubeUrl" target="_blank" rel="noopener noreferrer"
             (click)="$event.stopPropagation()"
             class="w-[38px] h-[38px] rounded-full bg-background/80 backdrop-blur-sm border border-border/50 flex items-center justify-center text-foreground hover:bg-background hover:border-primary transition-all duration-300 shadow-[0_0_15px_rgba(255,0,0,0.5)] hover:shadow-[0_0_20px_rgba(255,0,0,0.7)] group"
             title="YouTube">
            <svg class="w-[19px] h-[19px]" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a [href]="twitterUrl" target="_blank" rel="noopener noreferrer"
             (click)="$event.stopPropagation()"
             class="w-[38px] h-[38px] rounded-full bg-background/80 backdrop-blur-sm border border-border/50 flex items-center justify-center text-foreground hover:bg-background hover:border-primary transition-all duration-300 shadow-[0_0_15px_rgba(29,161,242,0.5)] hover:shadow-[0_0_20px_rgba(29,161,242,0.7)] group"
             title="Twitter">
            <svg class="w-[19px] h-[19px]" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a [href]="facebookUrl" target="_blank" rel="noopener noreferrer"
             (click)="$event.stopPropagation()"
             class="w-[38px] h-[38px] rounded-full bg-background/80 backdrop-blur-sm border border-border/50 flex items-center justify-center text-foreground hover:bg-background hover:border-primary transition-all duration-300 shadow-[0_0_15px_rgba(24,119,242,0.5)] hover:shadow-[0_0_20px_rgba(24,119,242,0.7)] group"
             title="Facebook">
            <svg class="w-[19px] h-[19px]" fill="currentColor" viewBox="0 0 24 24">
        ...
        <button
          ...
          class="absolute bottom-4 right-4 z-10 w-[54px] h-[54px] rounded-full bg-background/80 backdrop-blur-sm border border-border/50 flex items-center justify-center text-foreground hover:bg-background hover:border-primary transition-all duration-300 shadow-[0_0_20px_rgba(59,130,246,0.6)] hover:shadow-[0_0_25px_rgba(59,130,246,0.8)] group"
          [class.opacity-0]="isLoading"
